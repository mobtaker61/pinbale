export const faMessages = {
  ...
  start:
    ...
    '• /list — لیست موضوع‌ها\n' +
    '• /instagram یا /ig — پست‌های اخیر یک حساب عمومی اینستاگرام (تعداد از تنظیم سرور)\n' +
    '• /help — راهنما\n\n' +
  ...
  helpLines: [
    ...
    '- /instagram نام‌کاربری یا /ig نام‌کاربری — پست‌های اخیر اینستاگرام (عمومی، تعداد از سرور)',
  ...
  instagramQueued: 'در حال دانلود پست‌های اینستاگرام...',
  instagramNotFound: 'کاربری با این نام در اینستاگرام یافت نشد ❌',
