export const faMessages = {
  ...
  helpLines: [
    ...
    '- /pin — ارسال تصادفی ۱۰ تصویر از پوشهٔ images در سرور',
  ...
  searchDisabled: 'جستجوی پینترست در این ربات غیرفعال است. فقط /pin را بفرستید.',
  useCommandsHint:
    'برای دریافت تصویر، دستور /pin را بفرستید. راهنما: /help',
